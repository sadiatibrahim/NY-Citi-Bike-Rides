  ...
  template {
    spec {
      containers {
        ...
        env {
          name  = "GOOGLE_SERVICE_ACC_KEY_FILEPATH"
          value = "/secrets/credentials/mage_credentials"
        }
        volume_mounts {
          mount_path = "/secrets/credentials"
          name       = "secrets-mage_credentials"
        }
      }
      volumes {
        name = "secrets-mage_credentials"
        secret {
          secret_name = "mage_credentials"
          items {
            key  = "latest"
            path = "mage_credentials"
          }
        }
      }
    }
